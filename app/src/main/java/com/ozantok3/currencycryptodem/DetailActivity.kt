...
class DetailActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        activityDetails_imageView_cryptoImage.setImageDrawable(iconImageResource(activityDetail_textView_symbol.text.toString()))
    ...
    private fun iconImageResource(symbol: String): Drawable {
